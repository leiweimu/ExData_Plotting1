...
# and generates a matrix of multiple charts showing household energy usage over a 2-day 
...
# generates graphs, and saves to the preferable graphics device
imageName <- "plot4.png"
png(imageName, width = 480, height = 480)
par(mfrow = c(2, 2))
# first plot
with(df, plot(globalActivePower ~ datetime, type = "l", xlab = "", ylab = "Global Active Power"))
# second plot
with(df, plot(voltage ~ datetime, type = "l", xlab = "datetime", ylab = "Voltage"))
# third plot
...
# fourth plot
with(df, plot(globalReactivePower ~ datetime, type = "l", xlab = "datetime", ylab = "Global Reactive Power"))
dev.off()
